...
import { ValidationForgotPasswordDoctorSchema } from "./assets/ValidationForgotPasswordDoctorSchema"
...
const DoctorForgotPassword = ()=>{
    ...
    const onSubmit = async(values,action) => {
        try{
             await axios.post(
                "http://localhost:2000/api/forgotPasswordDoctor",
                values
            );
            Swal.fire({
                icon:"success",
    ...
    const {
        ...
        validationSchema:ValidationForgotPasswordDoctorSchema,
        onSubmit:onSubmit
    })
